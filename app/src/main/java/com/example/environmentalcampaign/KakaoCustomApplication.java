...
public class KakaoCustomApplication extends Application {
    private static volatile KakaoCustomApplication instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return KakaoCustomApplication.getGlobalApplicationContext();
                }
            };
        }
    }

    public static KakaoCustomApplication getGlobalApplicationContext() {
        if(instance == null) {
