...
import com.environmentalcampaign.MyAdapter;
...
public class FragmentCpMakeList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter1.addItem(100, 2, "버리스타", "2주", "주 2일", "00:00:00", "24:00:00", 20210501, ContextCompat.getDrawable(context, R.drawable.burista));
        return rootView;
    }
}